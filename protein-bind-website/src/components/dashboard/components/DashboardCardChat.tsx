...
const DashboardCardChat: React.FC = () => {
  const user = useUser();
  return (
        ...
        <div id="chartThree" className="mx-auto flex justify-center">
          <div className="flex items-start gap-2.5">
            <img
              ...
              alt="Jese image"
            />
            <div className="leading-1.5 border-gray-200 text-black dark:bg-gray-700 flex w-full max-w-[320px] flex-col rounded-es-xl bg-[#f3f4f6] p-4">
